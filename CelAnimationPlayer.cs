        ...
        public void Update(GameTime gameTime)
        {
            if (celAnimationSequence != null)
            {
                ...
                if (celTimeElapsed >= celAnimationSequence.CelTime)
                {
                    ...
                    celIndexX = (celIndexX + 1) % celAnimationSequence.celCountX;
                    celIndexY = (celIndexY + 1) % celAnimationSequence.celCountY;
                    celSourceRectangle.X = celIndexX * celSourceRectangle.Width;
                    celSourceRectangle.Y = celIndexY * celSourceRectangle.Height;
                }
            }
        }
